...
function generateScheduleForGrid(
  ...
  foreach ($modulesOrdered as $modCode) {
    ...
    foreach ($rows as $idx => $row) {
      ...
      $rows[$idx]['scheduled_time'] = $startTime . ' - ' . $endTime;

      // Override faculty with module mentor if provided
      if (!empty($mentorsByModule[$modCode])) {
                  ...
                  <tbody>
                    <?php foreach ($rows as $r): ?>
                      <tr>
                        ...
                        <td>
                          <input type="text" name="edit_time[<?= $modCode ?>][<?= $sessionNumber ?>]"
                            class="form-control form-control-sm time-input"
                            value="<?= h($r['scheduled_time'] ?? '') ?>">
                        </td>
                      </tr>
                    <?php endforeach; ?>
                  </tbody>
